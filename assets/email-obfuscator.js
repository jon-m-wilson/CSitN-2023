...
window.onload = function () {
    ...
    // Jon Wilson
   document.getElementById("organiser").innerHTML="<n uers=\"znvygb:wjvyfba30@hpyna.np.hx\" gnetrg=\"_oynax\"></n>".replace(/[a-zA-Z]/g,function(c){return String.fromCharCode((c<="Z"?90:122)>=(c=c.charCodeAt(0)+13)?c:c-26);});
